...
import ReportsAndRecordsPage from "./ReportsAndRecordsPage";


function MedicalRecordHistoryParent() {
                ...
                <div className="flex-1 flex flex-col">
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center px-4 md:px-6 py-4">
                        ...
                        <div>
                            ...
                            <h2 className="text-2xl font-semibold text-gray-800">Medical Records and History</h2>
                        </div>
...
export default MedicalRecordHistoryParent